...
// MARK: - Publishing Behavior
extension FormulaPublishControllerTests {
...
extension FormulaPublishControllerTests {
    ...
    func publishCreatesNewFormulaWhenMissing() throws {
        ...
        let (sut, store, projectFolder) = makeSUT(
            ...
            directoryMap: ["": tap2Directory, tap2Path: tap2Directory, project.path: project],
